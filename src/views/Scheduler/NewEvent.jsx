...
const Content = ({loginToken, plants, robots, shouldSubmit, onSubmit, ...props}) => {
...
const NewEvent = ({visible, onClose, onSubmit, ...props}) => {
    ...
    return (
        <Modal
                ...
                close={onClose}
                title="Scheduler"
                content={<Content shouldSubmit={shouldSubmit} onSubmit={onSubmit} {...props} />}
                footer={
                    <>
                        <button onClick={onClose} className="btn btn-secondary">
                            Close
                        </button>
                        <button onClick={() => {setShouldSubmit(true)}} className="btn btn-primary">
                            Schedule
                        </button>
                    </>
                }
