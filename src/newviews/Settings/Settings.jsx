...
const Settings = props => {
  ...
  const onChangePassword = async () => {
    if(newPassword !== confirmNewPassword) {
      showAlert(true);
      setAlertMessage("Make sure New Password and Confirm Password are identical!");
      setAlertType("error");
      return;
    }

    const response = await changePassword(loginToken, currentPassword, newPassword, confirmNewPassword);
    showAlert(true);
      ...
      content={
        <div>
          <div
            ...
            className={alertType === "success" ? "alert alert-success" : "alert alert-danger"}
            role="alert"
          >
            {alertMessage}
          </div>
