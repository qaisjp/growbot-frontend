...
function Gamepad(props) {
    const {classes, forward, backward, left, right, brake, armup, armdown} = props;
    return (
        <div style={styles} id="main-wrapper">
            <div id="arm-control-wrapper">
                <div className="grid-item">
                    <Fab size="large" color="secondary" aria-label="Add" className={classes.margin}
                         onClick={armup}>
                        <img src={tup} className="arrow-image arrow-vert" alt="Move arm up"/>
                    </Fab>
                </div>
                <div className="grid-item">
                ...
                <div className="grid-item">
                    <Fab size="large" color="secondary" aria-label="Add" className={classes.margin}
                         onClick={armdown}>
                        <img src={tdown} className="arrow-image arrow-vert" alt="Move arm down"/>
                    </Fab>
                </div>
            </div>
            <div id="directional-wrapper">
                ...
                <div className="grid-item">
                    <Fab size="large" color="secondary" aria-label="Add" className={classes.margin}
                         onClick={forward}>
                        <img src={tup} className="arrow-image arrow-vert" alt="Move bot forward"/>
                    </Fab>
                ...
                <div className="grid-item">
                    <Fab size="large" color="secondary" aria-label="Add" className={classes.margin}
                         onClick={left}>
                        <img src={tleft} className="arrow-image arrow-hor" alt="Move bot left"/>
                    </Fab>
                </div>
                <div className="grid-item">
                    <Fab size="large" color="secondary" aria-label="Add" className={classes.margin}
                ...
                <div className="grid-item">
                    <Fab size="large" color="secondary" aria-label="Add" className={classes.margin}
                         onClick={right}>
                        <img src={tright} className="arrow-image arrow-hor" alt="Move bot right"/>
                    </Fab>
                </div>
                <div className="grid-item"/>
                <div className="grid-item">
